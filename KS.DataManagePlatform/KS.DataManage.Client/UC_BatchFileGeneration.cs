...
namespace KS.DataManagePlatform
{
    public partial class BatchFileGeneration11 : KryptonForm
    {
        ...
        {
            //Task taskOneTouch = new Task(() =>
            //{
            //    if (this.InvokeRequired)
            //    {
            //        this.Invoke(new Action(() =>
            //        {
            foreach (DataGridViewRow itemSelectedRows in dataGridView.SelectedRows)
            {
                Task taskGroup = new Task(() =>
                {
                    if (this.InvokeRequired)
                    {
                        ...
                        {
                            #region 每组生成
                            string UserConfig = GlobalData.GetGeneConfigPath(itemSelectedRows.Cells[1].Value.ToString());
                            ...
                            this.SuspendLayout();
                            string ConfigFileName = GlobalData.GetDataConfigPath(itemSelectedRows.Cells[1].Value.ToString());
